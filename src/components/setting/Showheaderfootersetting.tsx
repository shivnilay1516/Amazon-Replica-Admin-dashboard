          ...
          {/* <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableCell isHeader>Logos</TableCell>
                <TableCell isHeader>Colors</TableCell>
            ...
            <TableBody className='px-2'>
              {loading ? (
                ...
                <TableRow>
                  <TableCell>Header/Footer Settings</TableCell>
                  <TableCell>
                    <div className="mb-2">
                  ...
                  <TableCell>
                    <div>Header BG: {settings.headerbgcolor}</div>
                    <div>Header Color: {settings.headercolor}</div>
                    <div>Footer Top BG: {settings.footertopbgcolor}</div>
                    <div>Footer Top Color: {settings.footertopcolor}</div>
                    <div>Footer BG: {settings.footerbgcolor}</div>
                    <div>Footer Color: {settings.footercolor}</div>
                    <div>Top Status: {settings.footertopstatus}</div>
                    <div>Footer Status: {settings.footerstatus}</div>
                  </TableCell>
                  <TableCell>
                    <Tooltip>
                ...
                <TableRow><TableCell colSpan={4}>No settings found.</TableCell></TableRow>
              )}
            </TableBody>
          </Table> */}
